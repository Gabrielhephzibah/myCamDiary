...
public class DataCollectorEditProfileViewModel extends BaseViewModel<DataCollectorEditProfileNavigator> {
    public DataCollectorEditProfileViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
