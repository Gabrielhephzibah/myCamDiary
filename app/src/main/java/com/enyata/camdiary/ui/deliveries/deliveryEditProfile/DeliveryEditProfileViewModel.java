...
public class DeliveryEditProfileViewModel extends BaseViewModel<DeliveryEditProfileNavigator> {
    public DeliveryEditProfileViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
