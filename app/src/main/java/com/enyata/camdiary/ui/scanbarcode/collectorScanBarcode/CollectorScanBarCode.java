...
public class CollectorScanBarCode extends AppCompatActivity implements  ZXingScannerView.ResultHandler  {
...
break;
    ...
    public void handleResult(Result rawResult) {
        ...
        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mScannerView.resumeCameraPreview(CollectorScanBarCode.this);
            }
        });
