...
public class DataCollectorBarcodeViewModel extends BaseViewModel<DataCollectorBarcodeNavigator> {
    public DataCollectorBarcodeViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
