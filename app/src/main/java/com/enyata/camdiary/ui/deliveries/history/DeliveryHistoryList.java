...
public class DeliveryHistoryList {
    ...
    public DeliveryHistoryList(String customerName, String deliveryItem, String phoneNumber, String deliveryId,String deliveryDate){
        myName = customerName;
        items = deliveryItem;
        number = phoneNumber;
        itemId= deliveryId;
